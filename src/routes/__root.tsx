...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Discover Sri Lanka your way. Tailor-made tours, private chauffeur transport, handpicked hotels and unforgettable experiences crafted by local experts." },
      { name: "author", content: "Urban Travels Sri Lanka" },
      { property: "og:title", content: "Urban Travels Sri Lanka — Discover Sri Lanka Your Way" },
      { property: "og:description", content: "Luxury tailor-made Sri Lanka tours, private chauffeurs, family holidays, honeymoons, wildlife & adventure." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Urban Travels Sri Lanka" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "icon", href: siteLogo, type: "image/jpeg" },
